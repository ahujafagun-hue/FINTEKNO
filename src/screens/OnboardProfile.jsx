    ...
    <>
      ...
      <div className="ob-layout">
        ...
        <div className="ob-right">
          ...
          <div className="upload-area" role="button" tabIndex={0} aria-label="Upload resume PDF or DOCX">
          ...
          <div className="uploaded-file" aria-label="Resume uploaded successfully">
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 12, fontWeight: 500, color: 'var(--text)' }}>Aryan_Resume_2025.pdf</div>
